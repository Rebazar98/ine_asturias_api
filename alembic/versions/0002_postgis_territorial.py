...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_territorial_units_parent_id", "territorial_units", ["parent_id"], unique=False
    )
    op.create_index(
        "ix_territorial_units_unit_level", "territorial_units", ["unit_level"], unique=False
    )
    op.create_index(
        "ix_territorial_units_normalized_name",
        "territorial_units",
        ["normalized_name"],
        unique=False,
    )
    op.create_index(
        "ix_territorial_units_level_parent",
        "territorial_units",
        ["unit_level", "parent_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_territorial_unit_codes_territorial_unit_id",
        "territorial_unit_codes",
        ["territorial_unit_id"],
        unique=False,
    )
    op.create_index(
        "ix_territorial_unit_codes_source_system",
        "territorial_unit_codes",
        ["source_system"],
        unique=False,
    )
    op.create_index(
        "ix_territorial_unit_codes_code_value",
        "territorial_unit_codes",
        ["code_value"],
        unique=False,
    )
    op.create_index(
        "ix_territorial_unit_codes_unit_source",
        "territorial_unit_codes",
        ["territorial_unit_id", "source_system"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_territorial_unit_aliases_territorial_unit_id",
        "territorial_unit_aliases",
        ["territorial_unit_id"],
        unique=False,
    )
    op.create_index(
        "ix_territorial_unit_aliases_normalized_alias",
        "territorial_unit_aliases",
        ["normalized_alias"],
        unique=False,
    )
    op.create_index(
        "ix_territorial_unit_aliases_lookup",
        "territorial_unit_aliases",
        ["normalized_alias", "source_system"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_territorial_unit_aliases_normalized_alias", table_name="territorial_unit_aliases"
    )
    op.drop_index(
        "ix_territorial_unit_aliases_territorial_unit_id", table_name="territorial_unit_aliases"
    )
    ...
    op.drop_index(
        "ix_territorial_unit_codes_territorial_unit_id", table_name="territorial_unit_codes"
    )
